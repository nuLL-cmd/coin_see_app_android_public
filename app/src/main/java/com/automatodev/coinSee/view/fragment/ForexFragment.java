...
public class ForexFragment extends Fragment {
   // private ProgressBar progressChart_main;
    ...
    private List<CoinChildr> coinForexList;
    private List<CoinChildr> coinForexAuxList;
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        coinForexList = new ArrayList<>();
        coinForexAuxList = new ArrayList<>();
        //---------------------------------
       return getLayoutInflater().inflate(R.layout.fragment_forex,container, false);
    }
