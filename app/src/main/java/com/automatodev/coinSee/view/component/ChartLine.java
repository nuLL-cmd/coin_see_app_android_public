...
public class ChartLine {
    ...
    public ChartLine(Activity context, List<CoinChildr> valueList) {
        this.context = context;
        this.valueList = valueList;
        convertDataService = new ConvertDataService();
    }
    ...
    public void makeGraph() {
       ...
       entradaTestes.add(new Entry(13,Float.parseFloat(valueList.get(0).getBid())));
        ...
        lineDataSet.setHighlightLineWidth(1f);// espessura da linha em fomra de cruz que que linka os dados do eixo y ao eixo x
